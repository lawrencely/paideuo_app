...
Paideuó allows you to create a task within a category and nominate a designated accountability partner who will check up on you. If the task was failed to be completed them will receive an email to check up on you.
